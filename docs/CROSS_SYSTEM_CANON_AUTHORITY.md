...
Repository role: **private operator/admin control plane**
...
- Admin authority does not grant child repos production release authority.
- Authentication/roles/auditability are mandatory.
- System registry statuses must not overstate runtime certification.
