...
// Example routes for incidents
router.get('/', (0, requireRole_1.requireRole)(['council', 'ops', 'superAdmin', 'auditor']), async (req, res) => {
    res.send('Get all incidents');
});
router.post('/', (0, requireRole_1.requireRole)(['council', 'ops', 'superAdmin']), async (req, res) => {
    res.send('Create an incident');
});
