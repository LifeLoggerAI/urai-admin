  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24, fontFamily: 'system-ui, sans-serif' }}>
      <section style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ margin: '12px 0', fontSize: 40, lineHeight: 1.1, color: '#0f172a' }}>Page not found</h1>
        <p style={{ margin: 0, color: '#475569', lineHeight: 1.6 }}>The page you requested does not exist.</p>
