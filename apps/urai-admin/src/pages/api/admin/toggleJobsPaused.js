...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            jobsPaused = req.body.jobsPaused;
            if (typeof jobsPaused !== 'boolean') {
                return [2 /*return*/, res.status(400).json({ message: 'Invalid jobsPaused value' })];
            }
            try {
                // In a real application, you would store this value in a database
                // or a configuration management system.
                // For this example, we'll just log it to the console.
                console.log("Jobs paused status set to: ".concat(jobsPaused));
