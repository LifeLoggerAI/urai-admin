...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            exportsPaused = req.body.exportsPaused;
            if (typeof exportsPaused !== 'boolean') {
                return [2 /*return*/, res.status(400).json({ message: 'Invalid exportsPaused value' })];
            }
            try {
                // In a real application, you would store this value in a database
                // or a configuration management system.
                // For this example, we'll just log it to the console.
                console.log("Exports paused status set to: ".concat(exportsPaused));
