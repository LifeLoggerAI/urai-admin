...
var SelectTrigger = React.forwardRef < ((React.ElementRef),
...
var SelectScrollUpButton = React.forwardRef < ((React.ElementRef),
    (React.ComponentPropsWithoutRef)) > (function (_a, ref) {
...
var SelectScrollDownButton = React.forwardRef < ((React.ElementRef),
    (React.ComponentPropsWithoutRef)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SelectContent = React.forwardRef < ((React.ElementRef),
    (React.ComponentPropsWithoutRef)) > (function (_a, ref) {
...
var SelectSeparator = React.forwardRef < ((React.ElementRef),
    (React.ComponentPropsWithoutRef)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
