...
var Table = React.forwardRef < (HTMLTableElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
...
var TableHeader = React.forwardRef < (HTMLTableSectionElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<thead ref={ref} className={cn("[&_tr]:border-b", className)} {...props}/>);
});
TableHeader.displayName = "TableHeader";
var TableBody = React.forwardRef < (HTMLTableSectionElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<tbody ref={ref} className={cn("[&_tr:last-child]:border-0", className)} {...props}/>);
});
TableBody.displayName = "TableBody";
var TableFooter = React.forwardRef < (HTMLTableSectionElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<tfoot ref={ref} className={cn("border-t bg-muted/50 font-medium [&>tr]:last:border-b-0", className)} {...props}/>);
});
TableFooter.displayName = "TableFooter";
var TableRow = React.forwardRef < (HTMLTableRowElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var TableHead = React.forwardRef < (HTMLTableCellElement,
    (React.ThHTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var TableCell = React.forwardRef < (HTMLTableCellElement,
    (React.TdHTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<td ref={ref} className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0", className)} {...props}/>);
});
TableCell.displayName = "TableCell";
var TableCaption = React.forwardRef < (HTMLTableCaptionElement,
    (React.HTMLAttributes)) > (function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
