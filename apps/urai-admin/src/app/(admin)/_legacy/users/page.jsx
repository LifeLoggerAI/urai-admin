    ...
    var handleRoleChange = function (uid, newRole) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch("/api/admin/users/".concat(uid, "/role"), {
                            method: 'PUT',
                ...
                case 3:
                    setUsers(users.map(function (u) { return (u.uid === uid ? __assign(__assign({}, u), { role: newRole }) : u); }));
                    alert('Role updated successfully!');
                    return [3 /*break*/, 5];
                case 4:
                    err_2 = _a.sent();
                    alert("Error: ".concat(err_2.message));
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white shadow-md rounded-lg">
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {users.map(function (adminUser) { return (<tr key={adminUser.uid} className="border-b border-gray-200 hover:bg-gray-100">
                ...
                {role === 'owner' && (<td className="py-3 px-6 text-center">
                    <select defaultValue={adminUser.role} onChange={function (e) { return handleRoleChange(adminUser.uid, e.target.value); }} className="border rounded px-2 py-1">
