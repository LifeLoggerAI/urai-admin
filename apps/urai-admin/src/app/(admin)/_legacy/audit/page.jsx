            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('/api/admin/audit')];
                    case 1:
                        res = _a.sent();
                        if (!res.ok) {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white shadow-md rounded-lg">
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {logs.map(function (log) { return (<tr key={log.id} className="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td className="py-3 px-6 text-left">
                  {log.metadata ? (<pre className="text-xs bg-gray-100 p-2 rounded">
