...
export function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionCookie, decodedToken, role, usersSnapshot, users, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, firestore.collection('adminUsers').get()];
                case 2:
                    usersSnapshot = _b.sent();
                    users = usersSnapshot.docs.map(function (doc) { return (__assign({ uid: doc.id }, doc.data())); });
                    return [2 /*return*/, NextResponse.json({ users: users })];
                case 3:
                    error_1 = _b.sent();
