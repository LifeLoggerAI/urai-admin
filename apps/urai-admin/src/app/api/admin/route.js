...
import { adminSetMaintenanceMode, adminToggleJobsPaused, adminToggleExportsPaused, adminInvalidateFoundationConfigCache, } from "./actions";
...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, action, payload, session, decodedClaims, isAdmin, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, request.json()];
                case 1:
                    _a = _c.sent(), action = _a.action, payload = _a.payload;
                    session = (_b = request.headers.get("Authorization")) === null || _b === void 0 ? void 0 : _b.split("Bearer ")[1];
                    if (!session) {
                ...
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, getAuth().verifySessionCookie(session, true)];
                case 3:
                    decodedClaims = _c.sent();
                    ...
                    switch (action) {
                        ...
                        case "adminInvalidateFoundationConfigCache":
                            ...
                            break;
                        default:
                            return [2 /*return*/, NextResponse.json({ error: "Invalid action" }, { status: 400 })];
                    }
