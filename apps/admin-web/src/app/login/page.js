...
function LoginPage() {
    ...
    return (<div className="flex items-center justify-center h-screen bg-gray-900">
      <card_1.Card className="w-full max-w-sm">
        <card_1.CardHeader>
          <card_1.CardTitle className="text-2xl">URAI-ADMIN Login</card_1.CardTitle>
        </card_1.CardHeader>
        <card_1.CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <input_1.Input type="email" placeholder="Email" value={email} onChange={function (e) { return setEmail(e.target.value); }} required/>
            </div>
            <div>
              <input_1.Input type="password" placeholder="Password" value={password} onChange={function (e) { return setPassword(e.target.value); }} required/>
            </div>
