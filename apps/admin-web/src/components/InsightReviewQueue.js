...
exports.default = InsightReviewQueue;
var insights = [
...
function InsightReviewQueue() {
    return (<div className="mt-4">
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            {insights.map(function (insight) { return (<tr key={insight.id} className="border-t dark:border-zinc-800">
