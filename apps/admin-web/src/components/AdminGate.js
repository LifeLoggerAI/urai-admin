...
function AdminGate(_a) {
    var _this = this;
    var children = _a.children;
    var router = (0, navigation_1.useRouter)();
    var _b = (0, react_1.useState)({ status: "loading" }), state = _b[0], setState = _b[1];
    (0, react_1.useEffect)(function () {
        var unsub = firebaseClient_1.auth.onAuthStateChanged(function (u) { return __awaiter(_this, void 0, void 0, function () {
            var token, isAdmin;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, u.getIdTokenResult(true)];
                    case 1:
                        token = _b.sent();
                        isAdmin = Boolean((_a = token.claims) === null || _a === void 0 ? void 0 : _a.admin);
                        if (!isAdmin) {
    ...
    if (state.status === "not_admin") {
        ...
        <h1>Forbidden</h1>
        <p>{state.email ? "Signed in as ".concat(state.email) : "Signed in"}</p>
