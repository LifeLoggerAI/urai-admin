...
exports.ToastClose = exports.ToastAction = exports.ToastDescription = exports.ToastTitle = exports.Toast = exports.ToastViewport = exports.ToastProvider = void 0;
...
var Toast = React.forwardRef(function (_a, ref) { var className = _a.className, variant = _a.variant, props = __rest(_a, ["className", "variant"]); return (<ToastPrimitives.Root ref={ref} className={(0, utils_1.cn)(toastVariants({ variant: variant }), className)} {...props}/>); });
exports.Toast = Toast;
