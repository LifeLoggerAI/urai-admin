...
exports.SelectItem = exports.SelectContent = exports.SelectTrigger = exports.SelectValue = exports.Select = void 0;
...
var SelectTrigger = React.forwardRef(function (_a, ref) {
    ...
    {children}
    <SelectPrimitive.Icon asChild><lucide_react_1.ChevronDown className="h-4 w-4 opacity-50"/></SelectPrimitive.Icon>
...
var SelectContent = React.forwardRef(function (_a, ref) {
    ...
    <SelectPrimitive.Content ref={ref} className={(0, utils_1.cn)("relative z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md animate-in fade-in-80", position === "popper" && "translate-y-1", className)} position={position} {...props}>
      <SelectPrimitive.Viewport className={(0, utils_1.cn)("p-1", position === "popper" && "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]")}>
        {children}
...
var SelectItem = React.forwardRef(function (_a, ref) {
    ...
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator><lucide_react_1.Check className="h-4 w-4"/></SelectPrimitive.ItemIndicator>
    </span>
