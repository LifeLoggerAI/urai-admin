...
exports.default = MonetizationDashboard;
var monetizationMetrics = [
...
function MonetizationDashboard() {
    return (<div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {monetizationMetrics.map(function (metric) { return (<div key={metric.name} className="p-4 rounded-lg bg-zinc-100 dark:bg-zinc-800">
