    ...
    <div className="flex h-screen bg-gray-100">
      <div className="w-64 bg-gray-800 text-white">
        ...
        <nav>
          ...
          <Link href="/users" className="block py-2.5 px-4 rounded transition duration-200 bg-gray-700">Users</Link>
      ...
      <div className="flex-1 p-10">
        ...
        <div className="mt-6">
            <input type="text" placeholder="Search by UID or email" className="w-full p-2 border rounded"/>
        </div>
      </div>
    </div>
  );
