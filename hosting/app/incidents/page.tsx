    ...
    <div className="flex h-screen bg-gray-100">
      <div className="w-64 bg-gray-800 text-white">
        ...
        <nav>
          ...
          <Link href="/incidents" className="block py-2.5 px-4 rounded transition duration-200 bg-gray-700">Incidents</Link>
      ...
      <div className="flex-1 p-10">
        <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">New Incident</button>
        </div>
      </div>
    </div>
  );
